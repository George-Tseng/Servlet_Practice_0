...
/**
 * Servlet implementation class TestSt0126
 */
@WebServlet(
		urlPatterns = { "/test/TestSt0126" }, 
		initParams = { 
				@WebInitParam(name = "account", value = "Student026"), 
				@WebInitParam(name = "password", value = "Servlet123")
		})
public class TestSt0126 extends HttpServlet {
...
request.setCharacterEncoding("UTF-8");
		...
		if(inputAccount == null || inputAccount.equals("")) {
			...
			if(inputAccount.equals(account) && inputPassword.equals(password)) {
				message = "   <h1>驗證成功！</h1>" + System.lineSeparator() + "   <h1>您的帳號為：" + account + "，密碼為：" + password + "</h1>";
			}
